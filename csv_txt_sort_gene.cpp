...
//Take the input_matrix file (txt or csv) and a set with all the genes
//the researcher is interested in and output a much smaller file
//(of the same format as the input one, txt or csv) that contains only
//the lines where the first element (name of the gene) is in the set.
